        ...
        <Col md={4} className="project-card">
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="ED jobster"
              description="It is a job hiring Plateform that helps HR to find out right candidate for the job from the colleges ,Pre-screening assessment is the most time-saving feature
              for a recruiter.
              Interview scheduling becomes really easy with Edjobster’s
